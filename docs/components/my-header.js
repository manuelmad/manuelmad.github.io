class customHeader extends HTMLElement {
    ...
    static get observedAttributes() {
        return ["img", "link1", "link2", "link3", "link4"];
    }
        ...
        template.innerHTML = `
            <header>
                <div class="header-logo-container">
                    <a href="./index.html"><img src="${this.img}" alt="logo"></a>
                </div>
                <nav>
                    <div class="container__menu-principal">
                        <ul id="menu-principal">
                            <li><a href="./proyectos/proyectos.html">${this.link1}</a></li>
                            <li><a href="#personal-info">${this.link2}</a></li>
                            <li><a href="#curriculum">${this.link3}</a></li>
                            <li><a href="#contacto">${this.link4}</a></li>
                        </ul>
                    </div>
                    <div class="container__icono-menu">
                        ...
                        <ul id="menu-desplegable">
                            <li>
                                <a href="./proyectos/proyectos.html">
